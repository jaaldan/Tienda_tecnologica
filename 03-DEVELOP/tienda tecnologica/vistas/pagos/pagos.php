...
$conet = new conexion();
$c = $conet->conectando();
$query = "select count(*) as totalRegistros from pago";
...
if (isset($_POST['search'])) {
    $query2 = "select * from pago where metodo_pago like '%$obj->metodo_pago%' limit $desde, $maximoRegistros";
    $ejecuta2 = mysqli_query($c, $query2);
    $arreglo2 = mysqli_fetch_array($ejecuta2);
} else {
    $query2 = "select * from pago limit $desde, $maximoRegistros";
    $ejecuta2 = mysqli_query($c, $query2);
    $arreglo2 = mysqli_fetch_array($ejecuta2);
}
        ...
        <nav class="navbar navbar-expand-lg bg-">
                <div class="container-fluid">
                    <form class="d-flex" role="search">
                        <input class="form-control me-2" type="search" name="metodo_pago"  placeholder="Digite el Nombre o Código del metodo de pago" aria-label="Search">
            ...
            <table class="table-light table table-striped table table-bordered border-success table table-hover">
                ...
                <?php
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>">
                                            <button type="button" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true">Modificar</i></button>
                                            </a>
                                            <a href="<?php if( $arreglo2[0]<>''){
                            ...
                            <a href="pagos_agregar.php" target="marco">
                                <button name="button" class="btn btn-success"><i class="fa fa-address-book-o" aria-hidden="true">Agregar metodo de pago</i></button>
                            </a>
                        </P>
                        <br>
