...
if ($arreglo2 == 0) {
    ...
    do {
        ...
        ?>"
                                                <center><button name="ver" class="btn btn-primary" type="button"><i class="fa fa-eye" aria-hidden="true">Ver</i></button></center>
                                            </a>
                                            <a href="<?php if ($arreglo2[0] != '') {
        ...
        ?>"
                                                <center><button name="modificar" class="btn btn-warning" type="button"><i class="fa fa-pencil" aria-hidden="true">Modificar</i></button></center>
                                            </a>
        ...
        ?>">
                                <center><button name="eliminar"type="button" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true">Eliminar</i></button></center>
                            </a>
                              </td>
                              </tr>
                              <?php
