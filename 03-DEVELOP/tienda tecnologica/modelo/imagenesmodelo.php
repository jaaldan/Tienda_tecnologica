                                           ...
                                           if(mysqli_fetch_array($ejecuta)){
                                              echo "<script> alert('No se ha realizado ninguna modificación en el sistema')</script>";
                                               ...
                                               $update = "update imagenes set id_imagen='$this->id_imagen',
                                                          id_producto_imagen='$this->id_producto_imagen',
                        ...
                        function eliminar(){
                                          try{
                                           ...
                                           if(mysqli_errno()==1451){
                                              echo "<script> alert('La imagen no fue eliminada en el sistema porque tiene registros asociados')</script>";
                                            }else{
                                               echo "<script> alert('La imagen fue eliminada del Sistema')</script>";
                                            }
                                          }
