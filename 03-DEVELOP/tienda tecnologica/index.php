...
<body>
    <div class="page-container">
        ...
        <div class="content-page cover-background font-content-index">
            <div class="jumbotron">
              <h1 class="tittles-pages">Bienvenido a Tienda Tecnologica</h1>
              <p>Todo en adcesorios de computo y celulares en la comodidad de tu hogar, registrate para conocer todo nuestro portafolio de productos.
              </p>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 text-center">
                            <p class="tittles-pages">Sistemas en que funcionan nustros adcesorios, teléfonos y tablets</p>
                            <br><br><br>
                        </div>
                    </div>
                    <div class="row">
