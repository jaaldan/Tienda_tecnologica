                ...
                <table class="table table-striped table-hover table table-bordered table-sm shadow">
                    <tr class="text-center align-middle">
                        ...
                        <td class="text-center">
                            ...
                            value="<?php echo $arreglo6[0] ?>" placeholder="El Codigo es Asignado por el Sistema" readonly maxlength="50" size="20">
                        </td>
                    </tr>
                    <tr class="text-center align-middle">
                        <th class="text-center">
                        ...
                        <td class="text-center">
                            ...
                            value="<?php echo $arreglo6[1] ?>" placeholder="Digite el Nombre del documento" maxlength="50" size="20">
                        </td>
                    </tr>
                    <tr class="text-center align-middle">
                        <th class="text-center">
                        ...
                        <td class="text-center">
                            ...
                            value="<?php echo $arreglo6[2] ?>" placeholder="Digite acronimo del documento" maxlength="50" size="20">
                        </td>
                    </tr>
                    <tr class="text-center align-middle">
                        <th class="text-center">
